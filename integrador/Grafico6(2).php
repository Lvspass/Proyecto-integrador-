...
<head>
    ...
    <title>Análisis del Desempeño en Cálculo Diferencial para Estudiantes de Ingeniería en Sistemas Computacionales
    </title>
...
<body>
    ...
    <?php  
        if($data[$i][1] == "Ingeniería en sistemas computacionales" && $data[$i][4] == "Si"){
        $aprobados = $aprobados +1;
        }
        else if($data[$i][1] == "Ingeniería en sistemas computacionales" && $data[$i][4] == "No"){
        $noAprobados = $noAprobados +1;
        }
        ?>
    <?php  
        if($data[$i][1] == "Ingeniería en sistemas computacionales" && $data[$i][3] == "Mujer" && $data[$i][4] == "Si"){
        $mujeres = $mujeres +1;
        }
        else if($data[$i][1] == "Ingeniería en sistemas computacionales" && $data[$i][3] == "Mujer" && $data[$i][4] == "No"){
        $noMujeres = $noMujeres +1;
        }
        else if($data[$i][1] == "Ingeniería en sistemas computacionales" && $data[$i][3] == "Hombre" && $data[$i][4] == "Si"){
        $hombres = $hombres +1;
        }
        else if($data[$i][1] == "Ingeniería en sistemas computacionales" && $data[$i][3] == "Hombre" && $data[$i][4] == "No"){
    ...
    <?php  
            if($data[$i][1] == "Ingeniería en sistemas computacionales" && $data[$i][2] == "Tercero" && $data[$i][4] == "Si"){
            $tercer = $tercer +1;
            }
            else if($data[$i][1] == "Ingeniería en sistemas computacionales" && $data[$i][2] == "Tercero" && $data[$i][4] == "No"){
            $noTercer = $noTercer +1;
            }
            else if($data[$i][1] == "Ingeniería en sistemas computacionales" && $data[$i][2] == "Quinto" && $data[$i][4] == "Si"){
            $quinto = $quinto +1;
            }
            else if($data[$i][1] == "Ingeniería en sistemas computacionales" && $data[$i][2] == "Quinto" && $data[$i][4] == "No"){
            $noQuinto = $noQuinto +1;
            }
            else if($data[$i][1] == "Ingeniería en sistemas computacionales" && $data[$i][2] == "Séptimo" && $data[$i][4] == "Si"){
            $septimo = $septimo +1;
            }
            else if($data[$i][1] == "Ingeniería en sistemas computacionales" && $data[$i][2] == "Séptimo" && $data[$i][4] == "No"){
    ...
    foreach ($data as $row) {
        if ($row[1] == "Ingeniería en sistemas computacionales") {
    ...
    <header>
        <h1><strong>Análisis del Desempeño en Cálculo Diferencial para Estudiantes de Ingeniería en Sistemas
            Computacionales</strong></h1>
    </header>
    <center>
    <p><strong>Introducción:</strong></p>
        ...
        <p>
            El Cálculo Diferencial es una asignatura fundamental en la formación de los estudiantes de Ingeniería en
            Sistemas Computacionales en el Instituto Tecnológico Superior de Teziutlán (ITST). Esta disciplina
            proporciona las bases matemáticas esenciales para la comprensión de conceptos avanzados y contribuye
            significativamente al desarrollo de habilidades analíticas necesarias en el ámbito de la informática.
        </p>

        <div>
            <img src="imagenes/im2.jpeg" alt="Descripción de la imagen" style="max-width: 30%; height: auto;">
        </div>
    </center>
    ...
    <p>
        Durante el último periodo académico, se realizó un análisis exhaustivo del desempeño de los estudiantes de
        Ingeniería en Sistemas Computacionales en Cálculo Diferencial. Los resultados revelaron aspectos destacados y
        desafíos importantes que requieren atención y acción.
    </p>

    <p><strong>Éxito y Desafíos:</strong></p>

    <p>
        Se evidenció un éxito destacado en gran parte de los estudiantes, resaltando su comprensión y aplicación de los
        conceptos clave en Cálculo Diferencial. No obstante, también se identificaron áreas específicas que presentaron
        desafíos para algunos alumnos.
    </p>
    ...
    <p>
        ...
        variado de los estudiantes en Cálculo Diferencial. Entre estos factores se incluyen:
    </p>

    <ol>
        <li><strong>Adaptación al Contenido Específico:</strong> Algunos estudiantes experimentaron dificultades al
            adaptarse al contenido específico del Cálculo Diferencial y su relación con los principios informáticos.
        </li>
        <li><strong>Metodologías de Enseñanza:</strong> Se está evaluando la efectividad de las metodologías de
            enseñanza utilizadas en el curso, considerando enfoques interactivos y recursos multimedia para mejorar la
            comprensión.</li>
    ...
    <p>
        El análisis del desempeño en Cálculo Diferencial para estudiantes de Ingeniería en Sistemas Computacionales
        proporciona valiosas perspectivas para mejorar continuamente la calidad de la educación en nuestro instituto. A
        través de medidas proactivas y adaptativas, estamos comprometidos a garantizar que cada estudiante alcance su
        máximo potencial en esta disciplina crucial.
    </p>

    <p>
        Este análisis forma parte de nuestro compromiso continuo con la excelencia académica y la mejora constante de
