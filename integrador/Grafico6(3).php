...
<head>
    ...
    <title>Análisis del Desempeño en Cálculo Diferencial para Estudiantes de Ingeniería Industrial</title>
...
<body>
    ...
    <?php  
        if($data[$i][1] == "Ingeniería industrial" && $data[$i][4] == "Si"){
        $aprobados = $aprobados +1;
        }
        else if($data[$i][1] == "Ingeniería industrial" && $data[$i][4] == "No"){
    ...
    <?php  
        if($data[$i][1] == "Ingeniería industrial" && $data[$i][3] == "Mujer" && $data[$i][4] == "Si"){
        $mujeres = $mujeres +1;
        }
        else if($data[$i][1] == "Ingeniería industrial" && $data[$i][3] == "Mujer" && $data[$i][4] == "No"){
        $noMujeres = $noMujeres +1;
        }
        else if($data[$i][1] == "Ingeniería industrial" && $data[$i][3] == "Hombre" && $data[$i][4] == "Si"){
        $hombres = $hombres +1;
        }
        else if($data[$i][1] == "Ingeniería industrial" && $data[$i][3] == "Hombre" && $data[$i][4] == "No"){
    ...
    <?php  
        if($data[$i][1] == "Ingeniería industrial" && $data[$i][2] == "Tercero" && $data[$i][4] == "Si"){
        $tercer = $tercer +1;
        }
        else if($data[$i][1] == "Ingeniería industrial" && $data[$i][2] == "Tercero" && $data[$i][4] == "No"){
        $noTercer = $noTercer +1;
        }
        else if($data[$i][1] == "Ingeniería industrial" && $data[$i][2] == "Quinto" && $data[$i][4] == "Si"){
        $quinto = $quinto +1;
        }
        else if($data[$i][1] == "Ingeniería industrial" && $data[$i][2] == "Quinto" && $data[$i][4] == "No"){
        $noQuinto = $noQuinto +1;
        }
        else if($data[$i][1] == "Ingeniería industrial" && $data[$i][2] == "Séptimo" && $data[$i][4] == "Si"){
        $septimo = $septimo +1;
        }
        else if($data[$i][1] == "Ingeniería industrial" && $data[$i][2] == "Séptimo" && $data[$i][4] == "No"){
    ...
    foreach ($data as $row) {
        if ($row[1] == "Ingeniería industrial") {
    ...
    <center>
    <header>
        <h1><strong>Análisis del Desempeño en Cálculo Diferencial para Estudiantes de Ingeniería Industrial</strong>
        </h1>
    </header>
    ...
    <p>
        El Cálculo Diferencial juega un papel fundamental en la formación de los estudiantes de Ingeniería Industrial en
        el Instituto Tecnológico Superior de Teziutlán (ITST). Esta disciplina proporciona las bases matemáticas
        esenciales para comprender conceptos avanzados y desempeña un papel crucial en la resolución de problemas en el
        ámbito industrial.
    <div>
        <img src="imagenes/im3.jpeg" alt="Descripción de la imagen" style="max-width: 30%; height: auto;">
    </div>
    </p>
    ...
    <p>
        En el último periodo académico, se realizó un análisis exhaustivo del desempeño de los estudiantes de Ingeniería
        Industrial en Cálculo Diferencial. Los resultados revelaron aspectos destacados y desafíos importantes que
        demandan atención y acción.
    </p>
    ...
    <p>
        ...
        clave en Cálculo Diferencial. Sin embargo, también se identificaron áreas específicas que presentaron desafíos
    ...
    <p>
        ...
        variado de los estudiantes. Entre estos factores se incluyen:
    </p>

    <ol>
        <li><strong>Relevancia Industrial:</strong> Algunos estudiantes experimentaron dificultades al comprender la
        aplicación directa de los conceptos de Cálculo Diferencial en el contexto industrial.</li>
        <li><strong>Metodologías de Enseñanza:</strong> Se está evaluando la efectividad de las metodologías de
        enseñanza utilizadas en el curso, considerando enfoques más prácticos y aplicados.</li>
    ...
    <p>
        El análisis del desempeño en Cálculo Diferencial para estudiantes de Ingeniería Industrial proporciona valiosas
        ...
        esta disciplina crucial para el ámbito industrial.
    </p>
